...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    public static final long MENU_ITEM_OPEN_CHANNEL_UPLOADS = 1L << 39;
    ...
    public static final long MENU_ITEM_DEFAULT = MENU_ITEM_PIN_TO_SIDEBAR | MENU_ITEM_NOT_INTERESTED | MENU_ITEM_NOT_RECOMMEND_CHANNEL
            ...
            | MENU_ITEM_OPEN_CHANNEL | MENU_ITEM_OPEN_CHANNEL_UPLOADS | MENU_ITEM_REMOVE_FROM_SUBSCRIPTIONS | MENU_ITEM_PLAY_NEXT | MENU_ITEM_OPEN_PLAYLIST
    ...
    private static final Long[] MENU_ITEM_DEFAULT_ORDER = {
            ...
            MENU_ITEM_SHOW_QUEUE, MENU_ITEM_OPEN_CHANNEL, MENU_ITEM_OPEN_CHANNEL_UPLOADS, MENU_ITEM_OPEN_PLAYLIST, MENU_ITEM_SUBSCRIBE, MENU_ITEM_EXCLUDE_FROM_CONTENT_BLOCK,
