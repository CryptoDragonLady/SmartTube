...
public class GeneralSettingsPresenter extends BasePresenter<Void> {
    ...
    private void appendMiscCategory(AppDialogPresenter settingsPresenter) {
        ...
        options.add(UiOptionItem.from(getContext().getString(R.string.long_press_back_exit),
                option -> mGeneralData.setLongPressBackExitEnabled(option.isSelected()),
                mGeneralData.isLongPressBackExitEnabled()));
